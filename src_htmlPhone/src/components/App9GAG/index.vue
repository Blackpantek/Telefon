<template>
  <div class="phone_app">
    <PhoneTitle :title="'📈Trending (' + currentSelectPost + ')'" backgroundColor="#000" @back="quit"/>  
...
export default {
  ...
  methods: {
    async loadItems () {
      let url = 'https://9gag.com/v1/group-posts/group/default/type/trending?' + this.nextCursor
