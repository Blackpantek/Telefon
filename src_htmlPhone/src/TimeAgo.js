...
const defaultLocales = {
  'sv_SE': [
    "Precis Nu",
      ["%s second ago", "för %s sekunder sen"],
      ["%s minute ago", "för %s minuter sen"],
      ["%s hour ago", "för %s timmar sen"],
      ["%s day ago", "för %s dagar sen"],
      ["%s week ago", "för %s veckor sen"],
      ["%s month ago", "för %s månader sen"],
      ["%s year ago", "för %s år sen"]
  ]
}
export default function install(Vue, { name = 'timeago', locale = 'sv_SE', locales = defaultLocales} = {} ) {
